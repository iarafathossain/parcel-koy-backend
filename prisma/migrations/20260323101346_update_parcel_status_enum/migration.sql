/*
  ...
  - The values [PICKUP_ASSIGNED,RECEIVED_ORIGIN_HUB,RECEIVED_DESTINATION_HUB] on the enum `ParcelStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ParcelStatus_new" AS ENUM ('REQUESTED', 'PICKUP_RIDER_ASSIGNED', 'PICKED_UP', 'PICKUP_FAILED', 'RECEIVED_AT_ORIGIN_HUB', 'IN_TRANSIT', 'RECEIVED_AT_DEST_HUB', 'OUT_FOR_DELIVERY', 'DELIVERED', 'PARTIAL_DELIVERY', 'DELIVERY_FAILED', 'ON_HOLD', 'RETURNED_TO_MERCHANT', 'CANCELLED');
